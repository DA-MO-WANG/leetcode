...
public class MergeX {
    ...
    private static void merge(Comparable[] src, Comparable[] dst, int lo, int mid, int hi) {
        System.out.print("merge开始前第一个数组情况：");
        show(src);
        System.out.print("merge开始前第二个数组情况：");
        show(dst);
        ...
        System.out.print("merge第1个位置数组情况：");
        show(src);
        System.out.print("merge第2个位置数组情况：");
        show(dst);
    ...
    private static void sort(Comparable[] src, Comparable[] dst, int lo, int hi) {
        ...
        int mid = lo + (hi - lo) / 2;
        sort(dst, src, lo, mid);
        System.out.print("sort处理后第一个位置数组情况：");
        show(dst);
        System.out.print("sort处理后第二个位置数组情况：");
        show(src);
    ...
    private static void merge(Object[] src, Object[] dst, int lo, int mid, int hi, Comparator comparator) {
        System.out.println("merge开始前数组情况：");
        show(dst);
        // precondition: src[lo .. mid] and src[mid+1 .. hi] are sorted subarrays
        ...
        // postcondition: dst[lo .. hi] is sorted subarray
        System.out.print("merge第二个位置数组情况：");
        show(dst);
